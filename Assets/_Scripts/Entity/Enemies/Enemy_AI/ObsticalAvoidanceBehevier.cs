...
public class ObstacleAvoidanceBehaviour : SteeringBehaviour
{
    ...
    public override (float[] danger, float[] interest) GetSteering(float[] danger, float[] interest, AI_Data aiData)
    {
        foreach (Collider2D obstacleCollider in aiData.obsticles)
        {
